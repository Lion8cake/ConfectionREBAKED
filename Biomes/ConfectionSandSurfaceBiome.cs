...
namespace TheConfectionRebirth.Biomes
{
	...
	public class ConfectionSandSurfaceBiome : ModBiome	
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Confection Desert Surface");
		}

		// Calculate when the biome is active.
		public override bool IsBiomeActive(Player player) {
			// First, we will use the exampleBlockCount from our added ModSystem for our first custom condition
			bool b1 = ModContent.GetInstance<ConfectionBiomeTileCount>().confectionSandBlockCount >= 40;
