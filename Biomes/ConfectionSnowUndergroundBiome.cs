...
{
	public class ConfectionSnowUndergroundBiome : ModBiome
	{
		...
		// Select Music
		public override int Music => MusicLoader.GetMusicSlot("Sounds/Music/ConfectionUnderground");
		...
		public override SceneEffectPriority Priority => SceneEffectPriority.BiomeHigh; // We have set the AVFXPriority to be BiomeLow for purpose of example, however default behavour is BiomeLow.
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Confection Ice Underground");
		}
		...
		public override bool IsBiomeActive(Player player) {
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) && 
				...
				ModContent.GetInstance<ConfectionSnowBiomeTileCount>().confectionSnowBlockCount >= 40 && 
