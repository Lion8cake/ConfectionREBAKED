...
{
	public class ConfectionSandUndergroundBiome : ModBiome
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Confection Desert Underground");
		}
		...
		public override bool IsBiomeActive(Player player) {
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) && 
				...
				ModContent.GetInstance<ConfectionBiomeTileCount>().confectionSandBlockCount >= 40 && 
