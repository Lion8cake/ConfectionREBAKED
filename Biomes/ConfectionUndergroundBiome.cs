...
namespace TheConfectionRebirth.Biomes
{
    public class ConfectionUndergroundBiome : ModBiome
    {
		...
		public override bool IsBiomeActive(Player player) => ModContent.GetInstance<ConfectionBiomeSurface>().IsBiomeActive(player) && (player.ZoneDirtLayerHeight || player.ZoneRockLayerHeight);
	}
}
