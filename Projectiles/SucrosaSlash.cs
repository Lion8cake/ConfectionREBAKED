...
namespace TheConfectionRebirth.Projectiles
{
    public class SucrosaSlash : ModProjectile
    {
        ...
        public void DrawProj_Excalibur(Projectile proj)
        {
            ...
            Main.spriteBatch.Draw(val.Value, vector, rectangle, color5 * 0.15f, proj.rotation + proj.ai[0] * 0.01f, origin, num * 0.6f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, rectangle, new Color(117, 43, 78) * 0.4f, proj.rotation, origin, num * 0.8f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, rectangle, new Color(167, 118, 65) * 0.4f, proj.rotation, origin, num * num4 * 0.6f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, val.Frame(1, 4, 0, 3), Color.White * 0.6f * num3, proj.rotation + proj.ai[0] * 0.01f, origin, num * 0.6f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, val.Frame(1, 4, 0, 3), Color.White * 0.5f * num3, proj.rotation + proj.ai[0] * -0.05f, origin, num * 0.8f * 0.6f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, val.Frame(1, 4, 0, 3), Color.White * 0.4f * num3, proj.rotation + proj.ai[0] * -0.1f, origin, num * 0.6f * 0.6f, effects, 0f);
            for (float num5 = 0f; num5 < 8f; num5++)
            {
                ...
                float num7 = num5 / 9f;
                DrawPrettyStarSparkle(proj.Opacity, SpriteEffects.None, drawpos, new Color(255, 255, 255, 0) * num3 * num7, new Color(117, 43, 78), new Color(25, 25, 25, 0), new Color(167, 118, 65, 0), num2, 0f, 0.5f, 0.5f, 1f, num6, new Vector2(0f, Utils.Remap(num2, 0f, 1f, 3f, 0f)) * num, Vector2.One * num);
            }
            ...
            DrawPrettyStarSparkle(proj.Opacity, SpriteEffects.None, drawpos2, new Color(255, 255, 255, 0) * num3 * 0.5f, new Color(117, 43, 78), new Color(167, 118, 65, 0), new Color(167, 118, 65, 0), num2, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(num2, 0f, 1f, 4f, 1f)) * num, Vector2.One * num);
        }
    ...
    public class SucrosaSlash2 : ModProjectile
    {
        public override string Texture => "TheConfectionRebirth/Projectiles/SucrosaSlash";
        ...
        public void DrawProj_Excalibur(Projectile proj)
        {
            ...
            color5.G = (byte)(color5.G * fromValue);
            color5.B = (byte)(color5.R * (0.25f + fromValue * 0.75f));
            Main.spriteBatch.Draw(val.Value, vector, rectangle, color5 * 0.15f, proj.rotation + proj.ai[0] * 0.01f, origin, num * 1f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, rectangle, new Color(102, 61, 49) * 0.4f, proj.rotation, origin, num * 1f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, rectangle, new Color(69, 41, 37) * 0.4f, proj.rotation, origin, num * num4 * 1f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, val.Frame(1, 4, 0, 3), Color.White * 0.6f * num3, proj.rotation + proj.ai[0] * 0.01f, origin, num * 1f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, val.Frame(1, 4, 0, 3), Color.White * 0.5f * num3, proj.rotation + proj.ai[0] * -0.05f, origin, num * 0.8f * 1f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, val.Frame(1, 4, 0, 3), Color.White * 0.4f * num3, proj.rotation + proj.ai[0] * -0.1f, origin, num * 0.6f * 1f, effects, 0f);
            for (float num5 = 0f; num5 < 8f; num5++)
            {
                float num6 = proj.rotation + proj.ai[0] * num5 * ((float)Math.PI * -2f) * 0.025f + Utils.Remap(num2, 0f, 1f, 0f, (float)Math.PI / 4f) * proj.ai[0];
                Vector2 drawpos = vector + num6.ToRotationVector2() * (val.Value.Width * 0.5f - 6f) * num * 1f;
                float num7 = num5 / 9f;
                DrawPrettyStarSparkle(proj.Opacity, SpriteEffects.None, drawpos, new Color(255, 255, 255, 0) * num3 * num7, new Color(102, 61, 49), new Color(25, 25, 25, 0), new Color(102, 61, 49, 0), num2, 0f, 0.5f, 0.5f, 1f, num6, new Vector2(0f, Utils.Remap(num2, 0f, 1f, 3f, 0f)) * num, Vector2.One * num);
            }
            Vector2 drawpos2 = vector + (proj.rotation + Utils.Remap(num2, 0f, 1f, 0f, (float)Math.PI / 4f) * proj.ai[0]).ToRotationVector2() * (val.Value.Width * 0.5f - 4f) * num * 1f;
            DrawPrettyStarSparkle(proj.Opacity, SpriteEffects.None, drawpos2, new Color(255, 255, 255, 0) * num3 * 0.5f, new Color(102, 61, 49), new Color(102, 61, 49, 0), new Color(102, 61, 49, 0), num2, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(num2, 0f, 1f, 4f, 1f)) * num, Vector2.One * num);
        }
        private void UpdateEnchantmentVisuals()
        {
            if (Projectile.npcProj)
    ...
    public static class HitboxShit
    {
