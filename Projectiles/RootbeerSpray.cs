    ...
    public class RootbeerSpray : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int num151 = 0; num151 < 3; num151++)
            {
                ...
                int num154 = 14;
                int num155 = Dust.NewDust(new Vector2(Projectile.position.X + num154, Projectile.position.Y + num154), Projectile.width - num154 * 2, Projectile.height - num154 * 2, ModContent.DustType<Dusts.RootbeerSplash>(), 0f, 0f, 100);
            ...
            {
                int num156 = 16;
                int num133 = Dust.NewDust(new Vector2(Projectile.position.X + num156, Projectile.position.Y + num156), Projectile.width - num156 * 2, Projectile.height - num156 * 2, ModContent.DustType<Dusts.RootbeerSplash>(), 0f, 0f, 100, default(Color), 0.5f);
