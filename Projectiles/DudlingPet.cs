...
namespace TheConfectionRebirth.Projectiles
{
	public class DudlingPet : ModProjectile
	{
		...
		public override void AI() {
			...
			if (player.GetModPlayer<ConfectionPlayer>().dudlingPet)
			{
			...
			if (Projectile.ai[0] != 0f) //Flight
			{
				...
				Projectile.rotation += Projectile.spriteDirection == -1 ? float.DegreesToRadians(90) : float.DegreesToRadians(-90);
			}
			else //Walk
			{
