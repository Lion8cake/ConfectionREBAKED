...
namespace TheConfectionRebirth.Projectiles
{
    public class TrueSucrosaSlash : ModProjectile
    {
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			...
			ParticleSystem.AddParticle(new TrueNeapoliniteSlash(), positionInWorld, new Vector2(Main.rand.NextFloat(-0.5f, 0.5f), 1), default, 24);
		...
		public override void AI() {
			...
			if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity) {
				Dust.NewDustPerfect(vector2, ModContent.DustType<NeapoliniteCrumbs>(), vector3 * 1f);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color color = Color.Lerp(new Color(27, 134, 169), new Color(47, 154, 169), amount);
			...
			Color color2 = Color.Lerp(new Color(153, 96, 62), new Color(32, 174, 221), amount);
			Color color3 = Color.Lerp(new Color(230, 196, 125), new Color(91, 209, 234), amount);
			...
			for (float num6 = 0f; num6 < 12f; num6 += 1f) {
				float num7 = Projectile.rotation + Projectile.ai[0] * num6 * ((float)Math.PI * -2f) * 0.025f + Utils.Remap(num2, 0f, 0.6f, 0f, 0.95504415f) * Projectile.ai[0];
				Vector2 drawpos = vector + num7.ToRotationVector2() * ((float)asset.Width() * 0.5f - 6f) * num;
				float num8 = num6 / 12f;
				DrawPrettyStarSparkle(Projectile.Opacity, (SpriteEffects)0, drawpos, new Color(255, 255, 255, 0) * num3 * num8, color3, num2, 0f, 0.5f, 0.5f, 1f, num7, new Vector2(0f, Utils.Remap(num2, 0f, 1f, 3f, 0f)) * num5, Vector2.One * num5);
			}
			...
			DrawPrettyStarSparkle(Projectile.Opacity, (SpriteEffects)0, drawpos2, new Color(255, 255, 255, 0) * num3 * 0.5f, color3, num2, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(num2, 0f, 1f, 4f, 1f)) * num5, Vector2.One * num5);
			return false;
		}
