...
{
	public class ParfaitStrawberry : ModProjectile
	{
		...
		public override void AI()
		{
			if (Projectile.alpha == 0) {
				int num215 = Dust.NewDust(Projectile.oldPosition, Projectile.width, Projectile.height, ModContent.DustType<CreamSnowDust>(), 0f, 0f, 100, default(Color), 0.5f);
