...
{
    public class DeathsSlash : ModProjectile
    {
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			...
			ParticleSystem.AddParticle(new BloodyNeedle(), positionInWorld, new Vector2(Main.rand.NextFloat(-0.5f, 0.5f), 1), default, 24);
		...
		public override bool PreDraw(ref Color lightColor)
        {
			...
			Color color = new Color(81, 0, 22); //super dark red
			...
			Color color2 = new Color(223, 22, 49); //light red
			Color color3 = new Color(127, 0, 31); //dark red
