...
namespace TheConfectionRebirth.Dusts
{
	public class TintableBakersDust : ModDust
	{
		...
		public override bool PreDraw(Dust dust)
		{
			...
			color.A = 0;
			Main.spriteBatch.Draw(TextureAssets.Dust.Value, dust.position - Main.screenPosition, (Rectangle?)dust.frame, color, dust.GetVisualRotation(), new Vector2(4f, 4f), dust.scale, (SpriteEffects)0, 0f);
			return false;
		}
	}
}
