...
namespace TheConfectionRebirth.NPCs
{
	public class Pip : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			NPC.catchItem = ModContent.ItemType<Items.Pip>();
			NPC.npcSlots = 0.4f;
			Banner = NPC.type;
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			...
			else
			{
				...
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("PipGore").Type);
			}
		}
	}
}
