...
namespace TheConfectionRebirth.NPCs {
	...
	internal class GummyWyrmBody : ConfectionWormBody {
		public override void SetStaticDefaults() {
	...
	internal class GummyWyrmTail : ConfectionWormTail {
		public override void SetStaticDefaults() {
			NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers() {
				Hide = true
			};
	...
	/// </summary>
	public abstract class ConfectionWormHead : ConfectionWorm {
	...
	public abstract class ConfectionWormBody : ConfectionWorm {
	...
	public abstract class ConfectionWormTail : ConfectionWorm {
		public sealed override WormSegmentType SegmentType => WormSegmentType.Tail;

		internal override void BodyTailAI() {
			ConfectionWormBody.CommonAI_BodyTail(this);
		}
	}
}