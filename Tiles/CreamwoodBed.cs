...
namespace TheConfectionRebirth.Tiles
{
	public class CreamwoodBed : ModTile
	{
		...
		//public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(i * 16, j * 16, 64, 32, ModContent.ItemType<Items.Placeable.CreamwoodBed>());
		...
		public override void MouseOver(int i, int j) {
			...
			if (!Player.IsHoveringOverABottomSideOfABed(i, j)) {
				...
				player.noThrow = 2;
				player.cursorItemIconEnabled = true;
				player.cursorItemIconID = ModContent.ItemType<Items.Placeable.CreamwoodBed>();
			}
		}
	}
}