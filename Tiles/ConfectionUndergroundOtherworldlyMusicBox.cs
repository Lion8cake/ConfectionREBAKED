...
{
	internal class ConfectionUndergroundOtherworldlyMusicBox : ModTile
	{
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.ConfectionUndergroundOtherworldlyMusicBox>();
		}
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			if (frameX >= 36)
			{
				Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeable.ConfectionUndergroundOtherworldlyMusicBox>());
			}
		}
	}
}
