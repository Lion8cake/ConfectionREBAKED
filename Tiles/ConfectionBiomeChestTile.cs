...
namespace TheConfectionRebirth.Tiles
{
    public class ConfectionBiomeChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
			...
			RegisterItemDrop(ModContent.ItemType<ConfectionBiomeChestItem>());
		...
		public override bool LockChest(int i, int j, ref short frameXAdjustment, ref bool manual)
		{
			...
			if (style == 0 && NPC.downedPlantBoss)
			{
				return true;
			}
			return false;
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<ConfectionBiomeChestItem>();
