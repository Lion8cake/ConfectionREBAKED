...
namespace TheConfectionRebirth.Tiles
{
	public class CreamwoodClock : ModTile
	{
		public override void SetStaticDefaults() {
			...
			// Etc
			AddMapEntry(new Color(106, 65, 51), CreateMapEntryName()); // We don't need to call SetDefault() on CreateMapEntryName()'s return value if we have .lang files.
		}
		...
		//public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(i * 16, j * 16, 48, 32, ModContent.ItemType<Items.Placeable.CreamwoodClock>());
	}
}