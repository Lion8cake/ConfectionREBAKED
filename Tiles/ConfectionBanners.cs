...
{
    public class ConfectionBanners : ModTile //renake
    {
			...
			if (closer) {
				...
				switch (style) {
					...
					case 9:
						...
						break;
					case 10:
						type = ModContent.NPCType<Birdnana>();
						break;
					case 11:
						type = ModContent.NPCType<ChocolateBunny>();
						break;
					case 12:
						type = ModContent.NPCType<ChocolateFrog>();
						break;
					case 13:
						type = ModContent.NPCType<Pip>();
						break;
					case 14:
						//type = "CherryBug";
						break;
					...
					case 20:
						...
						break;
					case 21:
						//type = "GummyWyrmHead"; //whar was I thinking?????????
						//type = "GummyWyrmBody";
						//type = "GummyWyrmTail";
						break;
					case 22:
				...
				if (type != null) {
					Main.SceneMetrics.NPCBannerBuff[(int)type] = true;
