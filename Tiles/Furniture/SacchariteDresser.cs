			...
			if (Main.tile[i, j].TileFrameY == 0) {
				...
				if (Main.netMode == NetmodeID.MultiplayerClient) {
					if (left == player.chestX && top == player.chestY && player.chest != -1) {
						player.chest = -1;
						//Recipe.FindRecipes(); //TODO: fix chests not updating recipes
					...
					if (chestIndex != -1) {
						...
						if (chestIndex == player.chest) {
							player.chest = -1;
							//Recipe.FindRecipes(); //TODO: ...actually this is a dresser...
							SoundEngine.PlaySound(SoundID.MenuClose);
						}
						...
						//Recipe.FindRecipes(); //TODO: well then FIX IT!!!
					}
				}
			}
			else {
				...
				player.chest = -1;
				//Recipe.FindRecipes(); //TODO: ...on it boss
				player.SetTalkNPC(-1);
				Main.npcChatCornerItem = 0;
				Main.npcChatText = "";
