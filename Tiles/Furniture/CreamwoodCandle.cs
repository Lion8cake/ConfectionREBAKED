...
namespace TheConfectionRebirth.Tiles.Furniture
{
    public class CreamwoodCandle : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.CreamwoodCandle>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.CreamwoodCandle>();
		}
